...
/**
 * Esta actividad mantiene un único fragmento en la pantalla, con el contenido de la entrada. Solo la usarán los móviles.
 */
public class Activity_Detalle extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(Fragment_Detalle.ARG_ID_ENTRADA_SELECIONADA, 
